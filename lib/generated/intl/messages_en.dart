...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "c_fuck_miui" : MessageLookupByLibrary.simpleMessage("Oh Shit! It is detected that you are using MIUI, please make sure that your device is a version prior to MIUI 12.5 21.2.1, otherwise the installer cannot help you install the Google framework temporarily.\nThe Root version development plan for MIUI 21.2.1 is under development, so stay tuned."),
    ...
    "title_fuck_miui" : MessageLookupByLibrary.simpleMessage("Fuck Miui!"),
