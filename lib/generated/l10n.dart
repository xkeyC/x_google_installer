...
class S {
  ...
  /// `Xiaomi has removed the whitelist of the Google framework in Miui 12.5 v21.2.1 and later versions. If you are a MIUI before this version, you can continue to use this installer, else XGI cannot help you.`
